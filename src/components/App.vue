<template>
  <div class="App">
    ...
    <product-section
      v-for="(product, index) in language.products"
      :key="product.title"
      :font="product.font"
      :title="product.title"
    ...
    <div class="bg-gray-100 md:-mt-20 py-16 md:py-32">
      ...
      >
        <div
          v-for="card in language.productCards"
          :key="card.title"
          class="md:w-1/3"
        >
          <product-card
    ...
    <div class="bg-white text-gray-900 py-32">
      <div class="max-w-6xl mx-auto px-5">
        ...
        <div
          v-for="(stage, index) in language.stages"
          :key="stage.title"
    ...
    <div class="bg-white text-gray-900 py-32 links">
      <div class="max-w-6xl mx-auto px-5 link-content">
        <h2
          class="text-2xl md:text-4xl text-center font-medium flex items-center justify-center space-x-3 mb-12 md:mb-32 mx-auto"
        >
          <img src="../images/title_stick.png" class="w-8 h-8" />
...
<script lang="ts">
import { defineComponent, data, methods } from 'vue'
...
const lan = {
  zh: {
        ...
        list: [
          {
            title: '慢雾审计',
            url:
              'https://www.slowmist.com/security-audit-certificate.html?id=7b91209f526407299aee5f99688b62fb2c337a4316a6b305719a9e3cd5442348',
          },
          {
            title: 'CertiK审计',
    ...
    products: [
      {
        title: `优化的多资产AMM Dex`,
        subtitle: `无需信任和无需许可的，接受任何标准且非通缩型的ERC20代币。`,
        image: productImage1,
      ...
      },
      {
        ...
        subtitle: `来自xFarm投票池、普通池和创始团队的任何XDEX代币都是通过xHalfLife协议进行解锁，可解锁奖励在每个块中都会更新。`,
        image: productImage3,
        link: `https://xhalflife.xdefi.com`,
        font: '登录',
      },
    ],
  },
  en: {
    ...
    font2:
      'The xDex, xFarm, xHalfLife and DAO Protocols have been audited and released on Ethereum mainnet.',
    font3: 'The xSTA and xOption Protocols will release soon!',
    font4: 'WHITEPAPER',
    ...
    productCards: [
      ...
      {
        title: `xSTA`,
        subtitle: `The Stable Coin Minted From<br/>Crypto Assets`,
        image: productCardXperp,
