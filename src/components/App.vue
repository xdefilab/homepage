<template>
  <div class="App">
        ...
        <div class="flex items-center h-full md:w-1/2">
          <div class="md:-mt-12">
            ...
            <div class="text-xl mt-12">
              The xDex, xFarm, xHalfLife and DAO Protocols have been audited and
              released on Ethereum mainnet.
            </div>
            <div class="text-xl mt-5">
              The xPerp and xOption Protocols will release soon!
            </div>
            <br />
            <br />
    ...
    <div class="bg-gray-100 md:-mt-20 py-16 md:py-32">
      ...
      >
        <div v-for="card in productCards" :key="card.title" class="md:w-1/3">
          <product-card
            :title="card.title"
