  ...
  return (
    <div className="App">
      ...
      <div className='section1'>
        ...
        <div className='container' style={{position:'absolute', left: '50%', marginLeft: -600, top: 0}}>
          <div className='section1Content'>
            <div className='title'>A Well Established <br/>DeFi Protocol Stack</div>
            <div className='subTitle'>The xDex, xFarm, xHalfLife and DAO Protocol has been audited and released on public Kovan Testnet.</div>
            <div className='subTitle'>The xPerp and xNsure Protocol will release soon!   </div>
            <br/><br/>
            <a className='colorfulBtn' variant='contained' color='primary' href='/'>WHITEPAPER</a>
          </div>
        </div>
      </div>
      ...
      <div className='section2'>
        ...
        <div className='section2Content'>
          <div className='section2TextContent'>
              ...
              <div className='subTitle'>Trustless and Permissionless. Accept any standard and non-deflating ERC20.</div>
          </div>
      ...
      <div className='section3'>
        ...
        <div className='section2Content'>
          ...
          <div className='section2TextContent'>
              ...
              <div className='subTitle'>Fair launch and Antifragile. XDEX token distributed 100% based on community consessus and participation.</div>
          </div>
        </div>
        </div>
      </div>
        ...
        <div className='section2Content'>
          <div className='section2TextContent'>
              ...
              <div className='subTitle'>
                Any XDEX from XFarm voting pool, ordinary pool, and founder <br/>
                teams' fund, is rewarded through xHalfLife protocol. Withdrawable reward updated in every block.<br/>
              </div>
          </div>
          <div className='sectionImgBG'>
            <img src={stc1}  alt=''/>
                ...
                <div className='roadMapItem'>
                  <div className='roadMapItemContent'>
                    ...
                    <div className='subContent'>
                        ...
                        Medium Connections<br/>
                    </div>
                  </div>
                </div>
                <div className='circle active' style={{margin: '0 42px'}}></div>
              ...
              <div className='contentItem' style={{marginTop:50,}}>
                <div className='roadMapItem'>
                  <div className='roadMapItemContent'>
                    ...
                    <div className='subContent'>
                        1st Stage Milestone Airdrop<br/>
                        xPERP launch<br/>
                        xNsure development<br/>
                    </div>
                  </div>
                </div>
              ...
              <div className='contentItem' style={{marginTop:50}}>
                ...
                <div className='roadMapItem'>
                  <div className='roadMapItemContent'>
                    ...
                    <div className='subContent'>
                      General DeFi / ETH Mining Users<br/>
                      xNsure Audited
                    </div>
                  </div>
                </div>
